...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "DIGIMON_WORLD_2003_RECOMP_PROJECT_ROOT",
    .build_dir_env = "DIGIMON_WORLD_2003_RECOMP_BUILD_DIR",
    .force_setup_env = "DIGIMON_WORLD_2003_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_039.36_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "digimon_world_2003__Recompiled",
    .prepare_note =
